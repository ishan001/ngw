...
//Contact Form
    $('#contact-form').validator().on('submit', function (e) {
        if (e.isDefaultPrevented()) {
            ...
            $('#result').removeClass('alert-success text-danger').addClass('text-warning').html('Submitting....');
            $.post($form.attr('action'), $form.serialize(), function (response) {
                $('#result').removeClass('text-warning').addClass('text-success').html(response.message);
            });
